...
class ComponentOrchestratorTest {
     ...
     * Otherwise, the loop exits only once the [ComponentOrchestrator] comes around to calling [close].
     */
    ...
    companion object {
        ...
        val log: Logger = LoggerFactory.getLogger(ComponentOrchestratorTest::class.java)
